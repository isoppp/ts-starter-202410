...
export const SignUpVerificationEmail = ({ pathname = `/signup/${generateRandomURLString()}` }: Props) => {
      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            ...
            <Text style={paragraph}>Please click this button to create your account with a secure link</Text>
            <Section align='center' style={{ width: '320px' }}>
              <Row>
                <Button style={button} href={href}>
                  Create account to {serviceDomain}
                </Button>
              </Row>
            </Section>
